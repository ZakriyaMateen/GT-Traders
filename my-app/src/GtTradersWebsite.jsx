                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
                        {products.map((productCategory, categoryIndex) => (
                            <div key={categoryIndex} className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-4 sm:p-6 lg:p-8 hover:shadow-2xl transition-all duration-500">
                                <div className="text-center mb-6 sm:mb-8">
                                    <span className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 text-white px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium mb-3 sm:mb-4">
                                ...
                                <div className="relative">
                                    <div className="overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-gray-50 to-blue-50">
                                        <div
                                            className="flex transition-transform duration-500 ease-in-out"
                                            style={{ transform: `translateX(-${(activeCarousels[categoryIndex] || 0) * 100}%)` }}
                                        >
                                            {productCategory.items.map((item, itemIndex) => (
                                                <div key={itemIndex} className="w-full flex-shrink-0 p-3 sm:p-4 lg:p-6">
                                                    <div className="relative group">
                                                        <div className="relative overflow-hidden rounded-lg sm:rounded-xl mb-3 sm:mb-4">
                                                            <div className="w-full h-64 sm:h-80 lg:h-96 bg-gray-200 rounded-lg sm:rounded-xl overflow-hidden">
                                                                <img
                                                                    src={item.image}
                                                                    alt={item.name}
                                                            ...
                                                            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-lg sm:rounded-xl"></div>

                                                            <div className="absolute bottom-2 sm:bottom-4 left-2 sm:left-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium">
                                                                {item.price}
                                                            </div>
                                                        </div>
                                    ...
                                    <button
                                        ...
                                        className="hidden sm:block absolute left-2 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm p-2 sm:p-3 rounded-full shadow-lg hover:bg-white hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-10"
                                    >
                                        <ChevronLeft size={18} className="text-gray-700" />
                                    </button>
                                    <button
                                        onClick={() => nextSlide(categoryIndex)}
                                        className="hidden sm:block absolute right-2 top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-sm p-2 sm:p-3 rounded-full shadow-lg hover:bg-white hover:shadow-xl transition-all duration-300 transform hover:scale-110 z-10"
                                    >
                                    ...
                                    <div className="flex sm:hidden justify-between mt-4 px-2">
                                        <button
                                            onClick={() => prevSlide(categoryIndex)}
                                            className="bg-white/90 backdrop-blur-sm p-3 rounded-full shadow-lg hover:bg-white hover:shadow-xl transition-all duration-300 transform hover:scale-110"
                                        >
                                    ...
                                    <div className="flex justify-center space-x-2 mt-4 sm:mt-6">
                                        {productCategory.items.map((_, itemIndex) => (
                                            <button
                                                ...
                                                className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full transition-all duration-300 transform hover:scale-125 ${(activeCarousels[categoryIndex] || 0) === itemIndex
